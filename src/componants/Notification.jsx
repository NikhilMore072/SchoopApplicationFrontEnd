  ...
  return (
    <div className={styles.notification}>
      ...
      <ul className={styles.list}>
        ...
        <li>Sequi, ut? Fuga obcaecati quia quo voluptatem nam impedit adipisci non sequi in quisquam, ipsam, cumque culpa cum!</li>
        <li>Explicabo eum nobis quisquam atque adipisci illum, commodi aliquam omnis, maiores soluta exercitationem, minus optio voluptate. Tenetur?</li>
      </ul>
    </div>
  );
};
