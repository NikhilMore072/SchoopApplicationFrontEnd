                            ...
                            <div className="card-body ">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="house">House</label>
                                            <input type="text" id="house" name="house" placeholder="eg. Green House" className="form-control" required onChange={handleChange} value={formData.house} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="nationality">Nationality</label>
                                            <input type="text" id="nationality" name="nationality" placeholder="eg. Indian" className="form-control" required onChange={handleChange} value={formData.nationality} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="birth_place">Birth Place</label>
                                            <input type="text" id="birth_place" name="birth_place" placeholder="eg. Mumbai" className="form-control" required onChange={handleChange} value={formData.birth_place} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="emergency_name">Emergency Name</label>
                                            <input type="text" id="emergency_name" name="emergency_name" placeholder="eg. Jane Doe" className="form-control" required onChange={handleChange} value={formData.emergency_name} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="date_of_birth">Date of Birth</label>
                                            <input type="date" id="date_of_birth" name="date_of_birth" className="form-control" required onChange={handleChange} value={formData.date_of_birth} />
                                        ...
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="student_aadhaar_no">Student Aadhaar No</label>
                                            <input type="text" id="student_aadhaar_no" name="student_aadhaar_no" placeholder="eg. 9876-5432-1234" required className="form-control" onChange={handleChange} value={formData.student_aadhaar_no} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="caste">Caste</label>
                                            <input type="text" id="caste" name="caste" placeholder="eg. Brahmin" className="form-control" required onChange={handleChange} value={formData.caste} />
                                        </div>

                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="category">Category</label>
                                            <input type="text" id="category" name="category" placeholder="eg. General" className="form-control" required onChange={handleChange} value={formData.category} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="address">Address</label>
                                            <input type="text" id="address" name="address" placeholder="eg. 123 Main St" className="form-control" required onChange={handleChange} value={formData.address} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="city">City</label>
                                            <input type="text" id="city" name="city" placeholder="eg. Mumbai" className="form-control" required onChange={handleChange} value={formData.city} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="state">State</label>
                                            <input type="text" id="state" name="state" placeholder="eg. Maharashtra" className="form-control" required onChange={handleChange} value={formData.state} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="pincode">Pincode</label>
                                            <input type="text" id="pincode" name="pincode" placeholder="eg. 400001" className="form-control" required onChange={handleChange} value={formData.pincode} />
                                        </div>

                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="emergency_address">Emergency Address</label>
                                            <input type="text" id="emergency_address" name="emergency_address" placeholder="eg. 123 Emergency Street" required className="form-control" onChange={handleChange} value={formData.emergency_address} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="emergency_contact">Emergency Contact</label>
                                            <input type="text" id="emergency_contact" name="emergency_contact" placeholder="eg. +1234567890" required className="form-control" onChange={handleChange} value={formData.emergency_contact} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="transport_mode">Transport Mode</label>
                                            <input type="text" id="transport_mode" name="transport_mode" placeholder="eg. Bus" className="form-control" required onChange={handleChange} value={formData.transport_mode} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="vehicle_no">Vehicle No</label>
                                            <input type="text" id="vehicle_no" name="vehicle_no" placeholder="eg. MH-01-AB-1234" className="form-control" required onChange={handleChange} value={formData.vehicle_no} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            ...
                                            <input type="text" id="weight" name="weight" placeholder="eg. 70" className="form-control" required onChange={handleChange} value={formData.weight} />
                                        </div>

                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="blood_group">Blood Group</label>
                                            <input type="text" id="blood_group" name="blood_group" placeholder="eg. A+" required className="form-control" onChange={handleChange} value={formData.blood_group} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="allergies">Allergies</label>
                                            <input type="text" id="allergies" name="allergies" placeholder="eg. Pollen, Dust" required className="form-control" onChange={handleChange} value={formData.allergies} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            ...
                                            <input type="text" id="admitted_in_class" name="admitted_in_class" placeholder="eg. 5th" required className="form-control" onChange={handleChange} value={formData.admitted_in_class} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            ...
                                            <input type="text" id="grn_no" name="grn_no" placeholder="eg. 12345" className="form-control" required onChange={handleChange} value={formData.grn_no} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="student_id_no">Student ID No</label>
                                            <input type="text" id="student_id_no" name="student_id_no" placeholder="eg. 67890" required className="form-control" onChange={handleChange} value={formData.student_id_no} />
                                        </div>
                                        ...
                                        <div className="col-md-3 mb-2">
                                            ...
                                            <input type="text" id="height" name="height" placeholder="eg. 175" className="form-control" required onChange={handleChange} value={formData.height} />
                                        </div>
                                        <div className="col-md-3 mb-2">
                                            <label htmlFor="roll_no">Roll No</label>
                                            <input type="text" id="roll_no" name="roll_no" placeholder="eg. 101" className="form-control" required onChange={handleChange} value={formData.roll_no} />
                                        </div>
